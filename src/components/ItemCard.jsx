...
export default function ItemCard({ 
            ...
            if (playerDoc.exists()) {
                ...
                if (playerMoney >= price) {
                    await updateDoc(playerRef, {
                        ...
                        Inventory: arrayUnion(item)  // Guardar el objeto con más propiedades
                    });
    ...
    const handleBuyClick = () => {
        // Crear el objeto con todas las propiedades necesarias
        const item = { 
            title, 
            description, 
            imageSrc,    // Guardar la imagen
            category,    // Guardar la categoría
            proBarName,  // Guardar el nombre del atributo (ej: Defensa)
            proBarPercentage // Guardar el porcentaje del atributo (ej: Defensa 35%)
        };
